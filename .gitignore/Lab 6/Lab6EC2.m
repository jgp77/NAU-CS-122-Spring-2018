%{
    ...
    Skeleton for the second extra credit probem in lab 6.
    ...
    outcome using 2 attack dice and 1 defense die
...
function [attack_wins,defense_wins] = Lab6EC2
attack_wins=0;
defense_wins=0;
tie=0;
gamesPlayed=0;
for a1 =1:6
    for a2 = 1:6
            for d1=1:6
                ...
                elseif ( attackers(1) + attackers(2) <= defenders(1))
